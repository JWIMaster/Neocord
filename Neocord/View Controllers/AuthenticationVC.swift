...
/*
 ...
 class AuthenticationViewController: UIViewController {
     ...
     let submit2FAButton = UIButton(type: .custom)
     ...
     func setupUI() {
         ...
         emailField.translatesAutoresizingMaskIntoConstraints = false
         view.addSubview(emailField)
         let emailBackground = self.makeGlassBackground()
         emailBackground.isUserInteractionEnabled = false
         view.addSubview(emailBackground)
         emailBackground.pinToEdges(of: emailField, insetBy: .init(top: -5, left: -5, bottom: -5, right: -5))
         view.bringSubviewToFront(emailField)
         ...
         // 2FA
         twoFactorField.placeholder = "2FA Code"
         twoFactorField.borderStyle = .none
         twoFactorField.keyboardType = .numberPad
         twoFactorField.translatesAutoresizingMaskIntoConstraints = false
         twoFactorField.isHidden = true
         view.addSubview(twoFactorField)
